var Mermaid = function(config, images) {
    ...
    this.IMAGE_INACTIVE_FORMAT = "/img/carousel/ID_square.jpg";
    this.IMAGE_ACTIVE_FORMAT = "/img/carousel/ID_spike.jpg";
    this.IMAGE_MOBILE_INACTIVE_FORMAT = "/img/carousel/ID_mobile_open.jpg";
    this.IMAGE_MOBILE_ACTIVE_FORMAT = "/img/carousel/ID_mobile_close.jpg";
